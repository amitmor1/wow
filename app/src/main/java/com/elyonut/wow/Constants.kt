...
class Constants {
    companion object {
        ...
        const val CURRENT_THREATENING_BUILDINGS_SOURCE_ID = "current-threatening-buildings-source-id"
        const val CURRENT_THREATENING_BUILDINGS_LAYER_ID = "current-threatening-buildings-layer-id"
    }
}
//
//THREAT_LAYER_ID = "construction"
